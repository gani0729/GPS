...
class Simulator:
    def __init__(self):
        ...
        self.sample_submission = pd.read_csv('C:/Users/user/Desktop/GPS/sample_submission.csv')
        self.max_count = pd.read_csv('C:/Users/user/Desktop/GPS/max_count.csv')
        self.stock = pd.read_csv('C:/Users/user/Desktop/GPS/stock.csv')
        self.order = pd.read_csv('C:/Users/user/Desktop/GPS/order.csv')
