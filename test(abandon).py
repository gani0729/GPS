...
class EvalCallback_Display(EvalCallback): #학습과정 평가/평가기준은 evaluate
...
if __name__ == '__main__':
    ...
    order_data_orig = pd.read_csv('C:/Users/user/Desktop/GPS/order.csv')
    ...
    production_plan.to_excel('C:/Users/user/Desktop/GPS/production_plan_5.xlsx', index=False)